...
const projeto5 = [
  "/imagem/habit-hunter.png",
  "/imagem/habit-hunter-2.png",
  "/imagem/habit-hunter-2.png",
  "/imagem/habit-hunter-3.png",
  "/imagem/habit-hunter-4.png",
  "/imagem/habit-hunter-5.png"
];
...
<div className="">
  <div className="border-2 border-sky-400 rounded-xl overflow-hidden shadow-[0_0_10px_#38bdf8] hover:shadow-[0_0_20px_#1e40ff]">
    <Carrosel images={projeto5} />
  </div>

  <div className="projeto-inf fadeInRight">
    
    <h1 className='font-bold text-xl mt-6 mb-3'>
      <span className=" bg-gradient-to-r from-sky-400
       via-blue-500 to-purple-600 
      bg-clip-text text-transparent animate-gradient-x duration-300 ease-in-out">
      Habit
      </span> Hunter
    </h1>

    <p className='font-semibol'>
      Aplicação web que transforma tarefas do dia a dia em um sistema de progressão estilo jogo,
      onde cada ação concluída gera XP, permitindo evolução de nível ao longo do tempo. 
      Conta com verificação de tarefas diárias, registro de falhas por data e histórico de execuções,
